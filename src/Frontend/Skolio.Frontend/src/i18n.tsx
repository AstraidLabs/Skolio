...
const en = {
  ...
  profileRoleAssignmentsTitle: 'Role assignments (read-only)',
  profileNoRoleAssignments: 'No role assignments.',
  profileParentStudentLinksTitle: 'Parent-student links (read-only)',
  profileNoParentStudentLinks: 'No parent-student links.',
  profileTeacherAssignmentsTitle: 'Teacher assignments (read-only)',
...
const cs: Translations = {
  ...
  securitySummaryTitle: 'Bezpecnostni souhrn',
  securityCurrentEmail: 'Aktualni e-mail',
  securityEmailConfirmed: 'E-mail potvrzen',
  securityMfaEnabled: 'MFA zapnuto',
  securityRecoveryCodesLeft: 'Zbyvajici recovery kody',
  securityYes: 'Ano',
  securityNo: 'Ne',
  securityChangePasswordTitle: 'Zmena hesla',
  securityCurrentPassword: 'Aktualni heslo',
  securityNewPassword: 'Nove heslo',
  securityConfirmNewPassword: 'Potvrzeni noveho hesla',
  securityChangePasswordAction: 'Zmenit heslo',
  securityChangeEmailTitle: 'Zmena e-mailu',
  securityCurrentPasswordReauth: 'Aktualni heslo (re-auth)',
  securityNewEmail: 'Novy e-mail',
  securityRequestEmailChangeAction: 'Vyžádat zmenu e-mailu',
  ...
  securitySharedKey: 'Sdileny klic',
  securityAuthenticatorUri: 'Authenticator URI',
  securityVerificationCode: 'Verifikacni kod',
  securityConfirmMfaAction: 'Potvrdit MFA',
  securityMfaVerificationCode: 'MFA verifikacni kod',
  ...
  securityRecoveryCodesEmpty: 'Recovery kody se zobrazi az po potvrzeni setupu nebo regeneraci.',
  securityLoading: 'Nacitam security self-service...',
  securitySummaryNotAvailable: 'Security souhrn neni dostupny.',
  securityMfaEnabledSuccess: 'MFA zapnuto.',
  securityRecoveryRegeneratedSuccess: 'Recovery kody byly regenerovany.',
  securityForgotPasswordTitle: 'Zapomenute heslo',
  securityForgotPasswordDescription: 'Vyžádejte e-mail pro reset hesla. Odpoved je z bezpecnostnich duvodu genericka.',
  securityForgotPasswordAction: 'Odeslat reset e-mail',
  securityResetPasswordTitle: 'Reset hesla',
  securityResetPasswordDescription: 'Dokoncete reset hesla pomoci bezpecneho tokenu.',
  securityResetPasswordAction: 'Resetovat heslo',
  securityConfirmEmailChangeLoading: 'Potvrzuji zmenu e-mailu...',
  securityMissingResetParams: 'Chybi parametry reset tokenu.',
  securityMissingEmailConfirmParams: 'Chybi parametry potvrzeni e-mailu.',
  roleUser: 'U\u017Eivatel',
  ...
  profileRoleAssignmentsTitle: 'P\u0159i\u0159azen\u00ED rol\u00ED (jen pro \u010Dten\u00ED)',
  profileNoRoleAssignments: '\u017D\u00E1dn\u00E1 p\u0159i\u0159azen\u00ED rol\u00ED.',
  profileParentStudentLinksTitle: 'Vazby rodi\u010D-student (jen pro \u010Dten\u00ED)',
  profileNoParentStudentLinks: '\u017D\u00E1dn\u00E9 vazby rodi\u010D-student.',
  profileTeacherAssignmentsTitle: 'P\u0159i\u0159azen\u00ED u\u010Ditele (jen pro \u010Dten\u00ED)',
...
const sk: Translations = {
  ...
  profileRoleAssignmentsTitle: 'Priradenia rol\u00ED (iba na \u010D\u00EDtanie)',
  profileNoRoleAssignments: '\u017Diadne priradenia rol\u00ED.',
  profileParentStudentLinksTitle: 'Väzby rodi\u010D-\u0161tudent (iba na \u010D\u00EDtanie)',
  profileNoParentStudentLinks: '\u017Diadne väzby rodi\u010D-\u0161tudent.',
  profileTeacherAssignmentsTitle: 'Priradenia u\u010Dite\u013Ea (iba na \u010D\u00EDtanie)',
...
const de: Translations = {
  ...
  profileRoleAssignmentsTitle: 'Rollenzuweisungen (nur lesen)',
  profileNoRoleAssignments: 'Keine Rollenzuweisungen.',
  profileParentStudentLinksTitle: 'Eltern-Schüler-Verknüpfungen (nur lesen)',
  profileNoParentStudentLinks: 'Keine Eltern-Schüler-Verknüpfungen.',
  profileTeacherAssignmentsTitle: 'Lehrerzuweisungen (nur lesen)',
...
const pl: Translations = {
  ...
  profileRoleAssignmentsTitle: 'Przypisania ról (tylko odczyt)',
  profileNoRoleAssignments: 'Brak przypisań ról.',
  profileParentStudentLinksTitle: 'Powiązania rodzic-uczeń (tylko odczyt)',
  profileNoParentStudentLinks: 'Brak powiązań rodzic-uczeń.',
  profileTeacherAssignmentsTitle: 'Przypisania nauczyciela (tylko odczyt)',
