...
public sealed class SchoolContextScopeAllowedAcademicsSectionConfiguration : IEntityTypeConfiguration<SchoolContextScopeAllowedAcademicsSection>
{
    public void Configure(EntityTypeBuilder<SchoolContextScopeAllowedAcademicsSection> builder)
    {
        builder.ToTable("school_context_scope_allowed_academics_sections");
