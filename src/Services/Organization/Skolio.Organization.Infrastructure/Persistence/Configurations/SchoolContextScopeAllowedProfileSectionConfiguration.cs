...
public sealed class SchoolContextScopeAllowedProfileSectionConfiguration : IEntityTypeConfiguration<SchoolContextScopeAllowedProfileSection>
{
    public void Configure(EntityTypeBuilder<SchoolContextScopeAllowedProfileSection> builder)
    {
        builder.ToTable("school_context_scope_allowed_profile_sections");
