...
public sealed class SchoolContextScopeAllowedCreateUserFlowConfiguration : IEntityTypeConfiguration<SchoolContextScopeAllowedCreateUserFlow>
{
    public void Configure(EntityTypeBuilder<SchoolContextScopeAllowedCreateUserFlow> builder)
    {
        builder.ToTable("school_context_scope_allowed_create_user_flows");
